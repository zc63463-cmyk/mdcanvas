...
import type { CharMeasure, Entity, EditableNode } from '@mindcanvas/kernel';
...
import { estimatePanVelocity, type PanSample } from './viewport.js';
import { lerpNodeFrame, toNodeFrame, type NodeFrame } from './transition.js';
import { dropModeFor, planDrop, type DropMode } from './nodeDrag.js';
...
const commentAreaH = estimateCommentAreaHeight();

/** 展开节点注释区 overlay：锚定节点本体下方（屏幕坐标），与 SVG 连体 + 内置滚动 */
function ExpandCommentOverlay({
  expandedId,
  layout,
  viewport,
  token,
